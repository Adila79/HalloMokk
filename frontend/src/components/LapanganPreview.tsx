  ...
  return (
    <section className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <h2 className="mt-4 max-w-3xl text-4xl font-bold text-slate-900">
          Pilih venue yang sesuai dengan kebutuhan latihan atau pertandingan.
        </h2>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
          Setiap lapangan didukung fasilitas yang konsisten untuk kenyamanan,
          keamanan, dan kualitas permainan.
        </p>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {lapangan.map((item) => (
            ...
            >
              <img
                src={`/lapangan/lapangan${item.id}.jpg`}
              ...
              <div className="p-6 text-slate-700">
                ...
                <Link
                  ...
                  className="mt-5 block rounded-full bg-slate-900 px-4 py-2.5 text-center text-sm font-semibold text-white transition hover:bg-slate-800"
                >
                  Booking Sekarang
                </Link>
              </div>
